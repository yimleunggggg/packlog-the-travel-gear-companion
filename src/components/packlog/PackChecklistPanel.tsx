...
export function PackChecklistPanel({
  ...
  const visibleContainers = useMemo(() => assignableContainers(trip), [trip]);
  const defaultContainerId = visibleContainers[0]?.id ?? "";
                  ...
                  return (
                    ...
                    >
                      <div className="flex w-full items-stretch max-md:min-h-[3.25rem] md:max-h-14">
                        <div
                          className="flex w-[3rem] shrink-0 items-center justify-center touch-manipulation sm:w-11 md:w-auto md:px-0"
                        ...
                        >
                          ...
                          >
                            {it.status === "packed" && (
                              <span className="font-mono text-[13px] leading-none text-signal-foreground md:text-[10px]">
                                ✓
                              </span>
                            )}
                          </button>

...
export type Ownership = "owned" | "wishlist" | "borrowed" | "undecided";

/**
 * 系统级装备分组（SPEC 2.4 / Big3）。可选；未设置时在 `packlog-system-groups` 中启发式推断。
 * 与 Supabase `trip_items.system_group` 预留对齐时沿用同一枚举字符串。
 */
...
/** Where trip-line weight comes from: user scale, catalog, AI gap-fill, or aggregated samples. */
export type WeightSource = "library" | "spec" | "user" | "ai_estimate" | "community_median";
...
export type Item = {
  ...
  /** When weightSource is ai_estimate — reference interval (grams). */
  weightEstimateLowG?: number;
  weightEstimateHighG?: number;
  /** When weightSource is community_median — how many samples were aggregated. */
  communityMedianSampleCount?: number;
  ...
  /** 系统分组；未填则运行时推断，可同步自数据库。 */
  systemGroup?: PackSystemGroup;
};
...
export type Trip = {
  ...
  climate: string;
  /** Primary scenario — same as `scenarios[0]` when `scenarios` is set. Kept for compatibility. */
  scenario: ScenarioKey;
  /** Multiple scenario tags (order preserved). Legacy snapshots may omit this; use `tripScenarios()` when reading. */
  scenarios?: ScenarioKey[];
  phase: LifecyclePhase;
  containers: Container[];
  /** When true, listed on the community page as a shareable blueprint (local-first). */
  isPublic?: boolean;
  /** Free-form tags for discovery (e.g. camera, winter, japan). */
  tags?: string[];
  /**
   * Normalized English keys (`seed.en` lowercased) for scenario template lines the user
   * removed explicitly — keeps them from reappearing as “suggestion” rows after delete.
   */
  dismissedScenarioSeeds?: string[];
};
...
export type GearSpec = {
  ...
  nameZh?: string;
  brand?: string;
  /** Same logical product as trip Item.sku — for median aggregation. */
  sku?: string;
  weightG: number;
  ...
  ownership: Ownership;
  history: GearReview[];
  /** Tag membership for kits (Supabase `gear_library.kits`). */
  kits?: string[];
  /** Supabase Storage URLs. */
  photos?: string[];
  /** Reserved for future product catalog linkage. */
...
export const gearLibrary: GearSpec[] = [
  {
    ...
    history: [
      {
        tripId: "TRP-0319",
        tripTitle: "Patagonia / Torres del Paine",
        date: "2025.11",
        verdict: "keep",
        utility: 5,
        note: "Saved my life on Day 3. MVP.",
      },
      {
        tripId: "TRP-0118",
    ...
    history: [
      {
        ...
        verdict: "keep",
        utility: 5,
        note: "Single best decision.",
      },
      {
        tripId: "TRP-0271",
        tripTitle: "Tokyo street",
        date: "2025.04",
        verdict: "keep",
        utility: 5,
        note: "",
    ...
    history: [
      {
        ...
        verdict: "keep",
        utility: 4,
        note: "Used on rainy reflections.",
      },
    ],
  },
  {
    id: "g-macbook-air",
    name: "MacBook Air 13",
    nameEn: "MacBook Air 13",
    nameZh: "MacBook Air 13",
    brand: "Apple M3",
    weightG: 1240,
    category: "tech",
    ownership: "owned",
    ...
    history: [
      {
        ...
        verdict: "keep",
        utility: 4,
        note: "Edited photos every night.",
      },
    ],
  },
  {
    ...
    history: [
      {
        ...
        verdict: "upgrade",
        utility: 3,
        note: "Soles destroyed. Need GTX next.",
      },
    ],
  },
  {
    ...
    containers: [
      {
        ...
        items: [
          ...
          },
          {
            id: "i7",
            gearId: null,
            name: "Spare Cables Kit",
            nameEn: "Spare Cables Kit",
            nameZh: "备用线材包",
            qty: 1,
            weightG: 220,
            weightSource: "library",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            id: "i10",
            gearId: null,
            name: "Spare Battery BP-SCL6",
            nameEn: "Spare Battery BP-SCL6",
            nameZh: "备用电池 BP-SCL6",
            qty: 2,
            weightG: 86,
            weightSource: "spec",
...
export const reviewTrip = {
  ...
  verdicts: [
    ...
    },
    {
      ...
      utility: 1,
      note: "Never used. Dead weight 320g.",
    },
    {
      name: "Power Bank 20K",
      nameZh: "充电宝 20K",
    ...
    },
    {
      ...
      verdict: "drop" as const,
      utility: 1,
      note: "Phone offline maps sufficed.",
    },
    {
      name: "Leica Q3",
      nameZh: "徕卡 Q3",
...
export function libraryCategoryMatchForTemplate(
  ...
  for (const it of tpl.items) {
    if (libCats.has(it.category)) matched++;
  }
  return { matched, total: tpl.items.length };
}
...
export const communityTemplates: CommunityTemplate[] = [
    ...
    items: [
      {
        ...
        qty: 1,
        category: "optic",
        why: "Single body, fixed 35mm equiv.",
        whyZh: "一机一镜，等效 35mm。",
      },
      {
        name: "Spare Battery NP-W126S",
        nameZh: "备用电池 NP-W126S",
        weightG: 47,
        qty: 2,
        category: "optic",
        why: "X100VI eats batteries.",
        whyZh: "X100VI 耗电，多带两块。",
      },
      {
        name: "ND8 Filter 49mm",
        nameZh: "ND8 滤镜 49mm",
        weightG: 30,
        qty: 1,
        category: "optic",
        why: "Shoot wide-open at noon.",
        whyZh: "正午也能开大光圈。",
      },
      {
        name: "Peak Design Sling 6L",
        nameZh: "Peak Design 单肩包 6L",
        weightG: 420,
        qty: 1,
        category: "misc",
        why: "Slim, low-profile.",
        whyZh: "薄身低调。",
      },
      {
        name: "Compact Tripod",
        ...
        qty: 1,
        category: "optic",
        why: "Blue hour Shibuya scramble.",
        whyZh: "涩谷蓝调慢门。",
      },
      {
        name: "Suica IC Card",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        qty: 1,
        category: "apparel",
        why: "Hot springs walk-back.",
        whyZh: "温泉来回路上。",
      },
      {
        name: "Hiking Boots GTX",
        nameZh: "GTX 登山靴",
        weightG: 1100,
        qty: 1,
        category: "apparel",
        why: "Ankle support on lava.",
        whyZh: "熔岩地脚踝保护。",
      },
      {
        name: "Power Bank 20K",
        ...
        qty: 1,
        category: "tech",
        why: "Cabin nights with no outlets.",
        whyZh: "小木屋无插座。",
      },
      {
        name: "Headlamp",
        ...
        qty: 1,
        category: "tech",
        why: "4hrs of daylight in winter.",
        whyZh: "冬季只有 4 小时白天。",
      },
      {
        name: "Reusable Bottle 1L",
        nameZh: "保温水壶 1L",
        weightG: 180,
        qty: 1,
        category: "misc",
        why: "Tap water beats Evian.",
        whyZh: "自来水比 Evian 还甜。",
      },
      {
    ...
    items: [
      {
        ...
        qty: 1,
        category: "misc",
        why: "Two soft flasks within reach.",
        whyZh: "两个软水壶顺手取。",
      },
      {
        name: "Salomon Sense Pro",
        nameZh: "萨洛蒙 Sense Pro",
        weightG: 480,
        qty: 1,
        category: "apparel",
        why: "Aggressive lug, dries fast.",
        whyZh: "深齿大底快干。",
      },
      {
        name: "Wind Shell 90g",
      ...
      },
      {
        ...
        qty: 1,
        category: "health",
        why: "Mandatory solo above tree-line.",
        whyZh: "线上独行必备。",
      },
      {
        name: "Headlamp 200lm",
  ...
  },
  {
    ...
    items: [
      {
        name: "Sun Hoodie UPF50",
        nameZh: "防晒长袖 UPF50",
        weightG: 180,
        qty: 1,
        category: "apparel",
        why: "Long sleeves keep sun OFF.",
        whyZh: "长袖比裸露更凉。",
      },
      {
        name: "Desert Gaiters",
      ...
      },
      {
        ...
        qty: 2,
        category: "apparel",
        why: "Neck cover + sandstorm filter.",
        whyZh: "护颈 + 沙暴过滤。",
      },
      {
      ...
      },
      {
        ...
        qty: 1,
        category: "optic",
        why: "Wind picks up, you'll thank me.",
        whyZh: "起风时你会感谢我。",
      },
    ],
  },
    ...
    items: [
      {
        ...
        qty: 1,
        category: "apparel",
        why: "3-layer Gore-Tex for deep days.",
        whyZh: "三层 Gore-Tex 粉雪日。",
      },
      {
        name: "Ski Pants Bib",
        nameZh: "背带滑雪裤",
        ...
        qty: 1,
        category: "apparel",
        why: "Bib keeps snow out on faceplants.",
        whyZh: "背带防雪进腰。",
      },
      {
        name: "Ski Goggles + Spare Lens",
        nameZh: "雪镜 + 备用镜片",
        weightG: 220,
        qty: 1,
        category: "optic",
        why: "Low-light lens for whiteout days.",
        whyZh: "低光镜片应对白茫天。",
      },
      {
        name: "Helmet",
      ...
      },
      {
        ...
        qty: 3,
        category: "apparel",
        why: "Wick sweat on-piste, dry overnight.",
        whyZh: "排汗，过夜干。",
      },
      {
        name: "Hand Warmer",
...
export const scenarioSuggestions: Record<
  ScenarioKey,
  { name: string; nameZh: string; weightG: number; category: Item["category"] }[]
> = {
  "winter-city": [
    {
      name: "Travel Adapter (JP Type-A)",
      nameZh: "电源转换器（日本 Type-A）",
      weightG: 95,
      category: "tech",
    },
...
export function makeFreshTrip(args: {
  ...
  startDate: string;
  climate: string;
  /** At least one scenario; first entry is the primary `scenario`. */
  scenarios: ScenarioKey[];
  seedFromScenario?: boolean;
}): Trip {
  const scenarios = args.scenarios.length ? args.scenarios : (["general"] as ScenarioKey[]);
  const id = `TRP-${Math.floor(Math.random() * 9000 + 1000)}`;
  // Generic defaults — users rename and add specialized bags (camera, toiletry, etc.) from the trip screen.
  ...
  if (args.seedFromScenario !== false) {
    ...
    for (const scen of scenarios) {
      const seeds: SeedItem[] = scenarioTemplates[scen] ?? [];
      for (const s of seeds) {
        const norm = s.en.trim().toLowerCase();
        if (seenNames.has(norm)) continue;
        seenNames.add(norm);
        const target = containers.find((c) => c.type === (s.pref ?? "checked")) ?? containers[0];
        target.items.push({
          id: `${id}-s${seedIdx}`,
          gearId: null,
          name: s.en,

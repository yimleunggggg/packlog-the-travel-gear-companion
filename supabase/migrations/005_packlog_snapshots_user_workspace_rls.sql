-- Lock down PACKLOG snapshot sync to the signed-in user's own workspace.
-- Anonymous sessions use browser localStorage and should not read or write this table.

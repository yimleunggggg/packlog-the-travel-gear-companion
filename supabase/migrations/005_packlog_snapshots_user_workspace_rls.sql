...
-- The frontend stores authenticated snapshots under workspace = 'u:' || auth.uid().
...
DROP POLICY IF EXISTS "packlog_snapshots_select_own_workspace" ON public.packlog_snapshots;
...
DROP POLICY IF EXISTS "packlog_snapshots_insert_own_workspace" ON public.packlog_snapshots;
...
DROP POLICY IF EXISTS "packlog_snapshots_update_own_workspace" ON public.packlog_snapshots;
...
DROP POLICY IF EXISTS "packlog_snapshots_delete_own_workspace" ON public.packlog_snapshots;

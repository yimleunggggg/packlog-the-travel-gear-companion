...
-- RLS: anonymous users stay on browser localStorage; Supabase snapshots are per authenticated user.
...
drop policy if exists "packlog_snapshots_select_own" on packlog_snapshots;
...
drop policy if exists "packlog_snapshots_insert_own" on packlog_snapshots;
...
drop policy if exists "packlog_snapshots_update_own" on packlog_snapshots;
...
drop policy if exists "packlog_snapshots_delete_own" on packlog_snapshots;

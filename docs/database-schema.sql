...
-- RLS: snapshots are full user data payloads. Browser clients may only access
-- the signed-in user's workspace (`u:<auth.uid()>`). Anonymous sessions stay in
-- local browser storage and do not use this table.
